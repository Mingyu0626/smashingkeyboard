...
{
    private const string enumFilePath = "Assets/02.Scripts/02-20. Utils/Tags.cs";

    [MenuItem("Tools/Generate Tag Enum")]
    public static void GenerateTagEnum()
    {
        if (!Directory.Exists("Assets/02.Scripts/02-20. Utils"))
        {
            Directory.CreateDirectory("Assets/02.Scripts/02-20. Utils");
        }
